...
class DotTrajectoryWithSound(Scene):
    def construct(self):
        ...
        self.add_sound("sounds/cartoon-189231_aJ9EIhA6.mp3", time_offset=0.8)
        ...
        self.play(sun.animate.move_to(positions["down-left"]),    run_time=move_time, rate_func=smooth)
